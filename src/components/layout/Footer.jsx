...
const Footer = () => {
    ...
    const linkAccentColorClass = 'text-[#FF4500]';       // Orange-Red for visibility against dark background
        ...
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        <h3 className="text-xl font-extrabold text-white mb-4" style={{ color: primaryRed }}>Ganga Mobiles</h3>
                        ...
                        <div className="space-y-2 text-sm">
                            <p className="text-gray-400">
                                <span className="font-semibold" style={{ color: primaryRed }}>Call Now:</span> 
                                <a href={`tel:${MAIN_PHONE}`} className={`ml-2 text-white font-bold ${hoverAccentColorClass}`}>
                                    {MAIN_PHONE}
                                </a>
                            </p>
                            <p className="text-gray-400">
                                <span className="font-semibold" style={{ color: primaryRed }}>Primary Branch:</span> 
                    ...
                    <div>
                        <h3 className="text-lg font-semibold text-white mb-4" style={{ color: primaryRed }}>Quick Links</h3>
                    ...
                    <div>
                        <h3 className="text-lg font-semibold text-white mb-4" style={{ color: primaryRed }}>Repair Services</h3>
                        <ul className="space-y-3 text-sm">
                            <li>
                    ...
                    <div>
                        <h3 className="text-lg font-semibold text-white mb-4" style={{ color: primaryRed }}>Our Pallikaranai Branch</h3>
                        <div className="space-y-4">
                            ...
                            <a
                                ...
                                style={{ borderColor: primaryRed, backgroundColor: '#1f2937' }} // Dark background for contrast
                ...
                <div className="mt-12 pt-8 border-t border-gray-700 text-center">
                    <p className="text-sm text-gray-500">
                        ...
                        <a href="/privacy" className={`hover:text-[#FF4500] transition-colors duration-200`} itemProp="url">
                            Privacy Policy
                        </a>
                    </p>
                </div>
