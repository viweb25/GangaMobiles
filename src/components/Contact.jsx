...
const accentBlue = '#4682B4'; // Steel Blue
...
const Contact = () => {
  ...
  const generateWhatsAppLink = () => {
    const message = encodeURIComponent(
      `*New Website Inquiry*\n\nName: ${name || 'N/A'}\nQuery: ${
        query || 'Need assistance with a repair or purchase.'
      }\n\nThank you!`
    );
  ...
  return (
    <div className="py-16 sm:py-24" style={{ backgroundColor: lightBlueBg }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            Get instant support for repairs, spares, or mobile purchases.{' '}
            <strong style={{ color: accentBlue }}>Message us on WhatsApp now!</strong>
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          {/* WhatsApp Inquiry */}
          <div
            className="lg:col-span-2 bg-white p-6 sm:p-12 rounded-3xl shadow-xl border-t-8"
            style={{ borderColor: primaryBlue }}
          >
            <h2
              className="text-3xl font-bold mb-8 border-b pb-4"
              style={{ color: primaryBlue, borderBottomColor: lightBlueBg }}
            >
            ...
            <div className="space-y-6">
              ...
              <a
                ...
                className={`w-full flex items-center justify-center py-4 rounded-xl text-white font-extrabold text-lg transition duration-300 shadow-xl ${
                  name ? 'hover:scale-[1.02]' : 'opacity-60 cursor-not-allowed'
                }`}
          ...
          {/* Quick Info */}
          <div
            className="bg-white p-6 sm:p-8 rounded-3xl shadow-xl border-b-8"
            style={{ borderBottomColor: primaryBlue }}
          >
            <h2
              className="text-2xl font-bold mb-6 border-b pb-3"
              style={{ borderBottomColor: lightBlueBg, color: primaryBlue }}
            >
              Quick Info
            </h2>

            {/* Phone */}
            <div className="mb-6 border-l-4 pl-4" style={{ borderColor: primaryBlue }}>
              <p className="text-lg font-semibold" style={{ color: accentBlue }}>
                Primary Contact
              </p>
              ...
              <p className="text-sm text-gray-600">
                Call the Pallikaranai branch directly.
              </p>
            </div>
            ...
            <div>
              ...
              <a
                href="/locations"
                className="font-bold transition mt-3 inline-block"
                style={{ color: primaryBlue }}
              >
                View All Branches
              </a>
